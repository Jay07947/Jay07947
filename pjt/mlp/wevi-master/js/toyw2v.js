...
function set_default_training_data() {
  var presets = 
    [{name:"Fruit and juice", data:"eat|apple,eat|orange,eat|rice,drink|juice,drink|milk,drink|water,orange|juice,apple|juice,rice|milk,milk|drink,water|drink,juice|drink"},
    	{name:"별점별 리뷰 키워드 (CBOW)", data:"하다|1,보다^영화|2,하다^보다^너무^느낌^내용|4,영화^좋다^평점|6,하다^보다^영화^있다^좋다^같다|8,원작^영화^보다^생각|9,하다^보다^영화^너무^연기^있다|10"},
    	{name:"가격 상승/하락 뉴스 키워드 (CBOW)",data:"증가^비싸^최고^고가^오름^강세^급등|가격상승,떨어^하락^감소^저렴^최저^약세^급감^할인^침체^안정세^잠잠|가격하락"},
    	{name:"가산혼합 색상 (CBOW)",data:"노랑^빨강|주황,빨강^파랑|보라,초록^노랑|연두,노랑^파랑|초록,흰색^빨강|분홍,흰색^파랑|하늘,주황^검정|갈색,빨강^파랑^초록|검정"},
    	{name:"가산혼합 색상2 (CBOW)",data:"노랑^빨강|주황,빨강^파랑|보라,초록^노랑|연두,노랑^파랑|초록,빨강^파랑^초록|검정"}
